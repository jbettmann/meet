...
const credentials = {
  ...
  redirect_uris: ["https://jbettmann.github.io/meet/"],
  javascript_origins: ["https://jbettmann.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  // a new OAuthClient always needs to be created in serverless because no state or memory of one before
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
